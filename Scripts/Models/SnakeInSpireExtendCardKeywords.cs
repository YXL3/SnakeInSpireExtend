...
public class SnakeInSpireExtendCardKeywords
{
    public static readonly CardKeyword Keen = ModContentRegistry.GetQualifiedKeywordId(Entry.ModId, nameof(Keen)).GetModCardKeyword();
